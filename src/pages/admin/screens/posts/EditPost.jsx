...
const EditPost = () => {
  ...
  const { data, isLoading, isError } = useQuery({
    ...
    onSuccess: (data) => {
      ...
      setisVisiblePost(data?.isVisible);
      setTags(data?.tags);
      setUrl(data?.url);
    },
  ...
  const {
    ...
    onSuccess: (data) => {
      ...
      toast.success(isVisiblePost ? "Post created" : "Post updated");
        ...
        <section className="container px-5 md:px-12 mx-auto max-w-5xl flex flex-col py-5 lg:flex-row lg:gap-x-5 lg:items-start">
          <article className="flex-1">
            ...
            <div className="flex justify-between gap-5">
              ...
              >
                {isVisiblePost ? t("admin.common.actions.delete") : t("admin.common.actions.cancel")}
              </button>
              <button
                disabled={isLoadingUpdatePostDetail}
                type="button"
              ...
              >
                {isVisiblePost ? t("admin.common.actions.publish") : t("admin.common.actions.update")}
              </button>
            </div>
          </article>
        </section>
